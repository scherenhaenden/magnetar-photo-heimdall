...
/// Never throws; all parsing errors are captured in <see cref="MetadataEvidenceBusinessLogicModel.ParseError"/>.
/// </summary>
public sealed class MetadataExtractorMediaMetadataReaderBusinessLogicService : IMediaMetadataReaderBusinessLogicService
{
    ...
    public async ValueTask<ResolvedCaptureDateBusinessLogicModel> ReadCaptureDateAsync(
        string filePath,
        CancellationToken ct = default)
    {
        ...
        var evidence = new List<MetadataEvidenceBusinessLogicModel>(4);
        ...
        {
            return new ResolvedCaptureDateBusinessLogicModel(
                exifEvidence.RawValue.Value,
                DateSourceBusinessLogicModel.ExifDateTimeOriginal,
                ExifConfidence,
                evidence.AsReadOnly());
        }
        ...
        if (xmpEvidence.RawValue.HasValue)
        {
            return new ResolvedCaptureDateBusinessLogicModel(
                ...
                DateSourceBusinessLogicModel.Xmp,
                XmpConfidence,
                evidence.AsReadOnly());
        }
        ...
        if (!qtEvidence.RawValue.HasValue)
        {
            ...
            {
                qtEvidence = new MetadataEvidenceBusinessLogicModel(filePath, DateSourceBusinessLogicModel.QuickTime, streamedQuickTime, QuickTimeConfidence, null);
            }
        }
        ...
        if (qtEvidence.RawValue.HasValue)
        {
            return new ResolvedCaptureDateBusinessLogicModel(
                ...
                DateSourceBusinessLogicModel.QuickTime,
                QuickTimeConfidence,
                evidence.AsReadOnly());
        }
        ...
        var mtimeEvidence = MetadataEvidenceBusinessLogicMapper.FromFilesystemMtime(filePath, mtime, MtimeConfidence);
        evidence.Add(mtimeEvidence);

        return new ResolvedCaptureDateBusinessLogicModel(mtime, DateSourceBusinessLogicModel.FilesystemMtime, MtimeConfidence, evidence.AsReadOnly());
    }

    // ── Private helpers ──────────────────────────────────────────────────────

    private static MetadataEvidenceBusinessLogicModel TryExtractExif(
        string filePath,
        IReadOnlyList<MetadataExtractor.Directory> directories,
        string? inheritedError)
    {
        ...
        {
            return new MetadataEvidenceBusinessLogicModel(filePath, DateSourceBusinessLogicModel.ExifDateTimeOriginal, null, ExifConfidence, inheritedError);
        }
        ...
        try
        {
            ...
            foreach (var dir in directories.OfType<ExifSubIfdDirectory>())
            {
                ...
                {
                    return new MetadataEvidenceBusinessLogicModel(
                        filePath, DateSourceBusinessLogicModel.ExifDateTimeOriginal,
        ...
        {
            return new MetadataEvidenceBusinessLogicModel(filePath, DateSourceBusinessLogicModel.ExifDateTimeOriginal, null, ExifConfidence, ex.Message);
        }

        return new MetadataEvidenceBusinessLogicModel(filePath, DateSourceBusinessLogicModel.ExifDateTimeOriginal, null, ExifConfidence, null);
    }

    private static MetadataEvidenceBusinessLogicModel TryExtractXmp(
        string filePath,
        IReadOnlyList<MetadataExtractor.Directory> directories)
    {
        try
                    ...
                    try
                    {
                        ...
                        if (!string.IsNullOrWhiteSpace(propValue) &&
                            DateTimeOffset.TryParse(propValue, CultureInfo.InvariantCulture,
                                ...
                                out var dto))
                        {
                            return new MetadataEvidenceBusinessLogicModel(filePath, DateSourceBusinessLogicModel.Xmp, dto, XmpConfidence, null);
                        }
                    }
        ...
        {
            return new MetadataEvidenceBusinessLogicModel(filePath, DateSourceBusinessLogicModel.Xmp, null, XmpConfidence, ex.Message);
        }
        ...
        try
        {
            ...
            {
                return new MetadataEvidenceBusinessLogicModel(filePath, DateSourceBusinessLogicModel.Xmp, embedded, XmpConfidence, null);
            }
        }
        catch (Exception ex)
        {
        ...
        return new MetadataEvidenceBusinessLogicModel(filePath, DateSourceBusinessLogicModel.Xmp, null, XmpConfidence, null);
    }
    ...
    private static MetadataEvidenceBusinessLogicModel TryExtractQuickTime(
        string filePath,
        IReadOnlyList<MetadataExtractor.Directory> directories)
    {
        try
        {
            foreach (var dir in directories.OfType<QuickTimeMovieHeaderDirectory>())
            {
                ...
                {
                    return new MetadataEvidenceBusinessLogicModel(
                        filePath, DateSourceBusinessLogicModel.QuickTime,
                        new DateTimeOffset(dt, TimeSpan.Zero),
        ...
        {
            return new MetadataEvidenceBusinessLogicModel(filePath, DateSourceBusinessLogicModel.QuickTime, null, QuickTimeConfidence, ex.Message);
        }

        return new MetadataEvidenceBusinessLogicModel(filePath, DateSourceBusinessLogicModel.QuickTime, null, QuickTimeConfidence, null);
    }
